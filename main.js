...
var me = {
    name: "Eric",
    city: "Scottsdale",
    family: ["Mike", "Carley", "Will"]
}

document.getElementById("q1").innerHTML = "My name is " + me.name + " and my city is " + me.city;

document.getElementById("q2").innerHTML = "My siblings are named " + me.family[0] + ", " + me.family[1] + ", and " + me.family[2];
...
document.getElementById("q3").innerHTML = "My city is " + me.city + me["city"];
...
document.getElementById("q10").innerHTML = "Constructor Notation: var jsWorkshop = new Object();";

// 11. To your "jsWorkshop" object, assign a key of "classmates" with the value being an array of five your classmates.

jsWorkshop.classmates = ["John", "Bob", "Lisa", "Doug", "Susan"]
...
books.ISBN22222.dateRead = "2000";
books.ISBN33333.dateRead = "2004";
books.ISBN44444.dateRead = "2009";

document.getElementById("qe").innerHTML = "Book 1 date is " + books.ISBN22222.dateRead + ", book 2 date is " + books.ISBN33333.dateRead + ", and book 3 date is " + books.ISBN44444.dateRead;

// F. Remove the second book from the books object.

document.getElementById("qf").innerHTML = delete books.ISBN33333;

// G. Explain, in your own words, the difference between Literal Notation and Constructor Notation.

document.getElementById("qg").innerHTML = "If you don't need anything beyond a simple container of data, you'll want to use this liternal notation method when working with objects.  The constructor notation allows you to add behaviour to your object after it has been created."
